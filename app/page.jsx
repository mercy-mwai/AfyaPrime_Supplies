  ...
  const services = [
    {
      ...
      description:
        "All products are certified and meet international medical standards",
    },
    {
      icon: Truck,
      title: "Fast Delivery",
      description:
        "Same day delivery within Nairobi, nationwide shipping available",
    },
    {
      icon: Award,
      title: "Expert Support",
      description:
        "Professional guidance from our medical equipment specialists",
    },
    {
      icon: Clock,
      title: "24/7 Service",
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-green-100">
                Discover premium medical supplies and equipment from leading
                manufacturers. Quality healthcare solutions for hospitals,
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600">
              Top-quality medical equipment at competitive prices
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              >
                <CardContent className="p-0">
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="text-lg font-semibold mb-2 line-clamp-2 text-slate-800">
                      {product.name}
                    </h3>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6 text-slate-800">
                About Afya Prime Supplies
              </h2>
              <p className="text-lg text-slate-600 mb-6">
                With over a decade of experience in the medical supply industry,
                Afya Prime Supplies has been Kenya's trusted partner in
                delivering quality healthcare solutions. We serve hospitals,
                clinics, laboratories, and healthcare professionals across East
                Africa.
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-slate-800 mt-8 pt-8 text-center">
            <p className="text-slate-400">
              © 2025 Afya Prime Supplies. All rights reserved. | Privacy Policy
              | Terms of Service
            </p>
          </div>
        </div>
